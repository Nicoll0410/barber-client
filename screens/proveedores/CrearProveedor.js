...
const CrearProveedor = ({ visible, onClose, onCreate }) => {
  ...
  useEffect(() => {
    const checkScreenSize = () => {
      ...
      setIsMobile(width < 768); // 768px is a common breakpoint for tablets
    };

    // Check on initial render
    checkScreenSize();

    // Add event listener for screen size changes (orientation changes)
  ...
  // Render for desktop/laptop (original layout)
  ...
  // Render for mobile/tablet (vertical layout)
